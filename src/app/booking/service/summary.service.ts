...
import { INIT_SUMMARY_FARE, ISummaryFare, ISummaryFlight, ISummaryTrip, ITrip } from '../interface/flight';
...
export class SummaryService {
  ...
  public getSummaryByAge2(flights: Array<ISummaryFlight>): Array<ISummaryFare> {
